ActionController::Routing::Routes.draw do |map|
  ...
  map.with_options :controller => 'reservations' do |m|
    ...
    m.show_reservations  'reservations',
                         :action => 'index'

    m.show_deputation    'reservations/:dep_id', 
                         :action => 'show' 

    m.book_reservation   'reservations/book/:book_id', 
                         :action => 'book' 

    m.update_reservation 'reservation/update', 
                         :action => 'update'
  ...
  map.with_options :path_prefix => '/admin' do |m|
    ...
    m.resources :bookings,    
                :controller => 'admin/bookings'

    m.resources :churches,     
                :controller => 'admin/churches'

    m.resources :deputations,  
                :controller => 'admin/deputations'

    m.resources :ministers,    
                :controller => 'admin/ministers'

    m.resources :missionaries, 
                :controller => 'admin/missionaries'
